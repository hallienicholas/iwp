...
class About extends Component{
    render(){
        return(
            ...
            <div className="row">
                <div className="col"><img className="mb-1 shadow" src="../img/hallienicholas.jpg" alt="Headshot" width="100px" height="130px" /></div>
            ...
            <div className="row">
                <div className="col"><img className="mb-1 shadow" src="../img/isaacparada.jpg" alt="Headshot" width="100px" height="130px" /></div>
            ...
            <div className="row">
                <div className="col"><img className="mb-1 shadow" src="../img/adamhungerford.jpg" alt="Headshot" width="100px" height="130px" /></div>
