...
class About extends Component{
    render(){
        return(
            ...
            <div className="row">
                <div className="col"><img src="../img/hallienicholas.jpg" alt="Headshot" width="120px" height="130px" /></div>
                <div className="col-10"><b>Hallie Nicholas</b> Hallie Nicholas is a senior at Messiah University. She is a computer science major with a business information systems concentration, and is the project manager and team lead of this web application.</div>
            </div>
            <div className="row">
                <div className="col"><img src="../img/isaacparada.jpg" alt="Headshot" width="120px" height="130px" /></div>
                <div className="col-10"><b>Isaac Parada</b> dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Phasellus faucibus scelerisque eleifend donec pretium vulputate sapien. Elementum sagittis vitae et leo duis ut diam quam. Feugiat sed lectus vestibulum mattis ullamcorper velit sed ullamcorper morbi. Tellus mauris a diam maecenas sed enim. Egestas erat imperdiet sed euismod nisi porta lorem mollis aliquam. Eu volutpat odio facilisis mauris sit amet massa vitae tortor. Mattis ullamcorper velit sed ullamcorper morbi tincidunt. Non enim praesent elementum facilisis. Consectetur adipiscing elit duis tristique sollicitudin nibh sit amet. In massa tempor nec feugiat nisl pretium.</div>
            </div>
            <div className="row">
                <div className="col"><img src="../img/adamhungerford.jpg" alt="Headshot" width="120px" height="130px" /></div>
